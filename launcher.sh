...
# Configuration paths
PV_WEB_SERVER_PATH=/home/evl/ssingh79/RemoteGL/visualizer/server/
PV_BUILD_PATH=/home/evl/ssingh79/RemoteGL/ParaView/
DATA_DIR=/home/evl/ssingh79/RemoteGL/Data/
...
file=$4
secret=$5
server=$PV_WEB_SERVER_PATH/pvw-visualizer.py
...
then server=$PV_WEB_SERVER_PATH/pvw-visualizer.py
fi
